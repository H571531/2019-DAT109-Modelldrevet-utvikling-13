...
alter table `shopping_cart`   add index fk_shopping_cart_customer (`id`), add constraint fk_shopping_cart_customer foreign key (`id`) references `customer` (`id`);


-- Customer_CreditCard [rel2]
alter table `creditcard`  add column  `id`  varchar(255);
alter table `creditcard`   add index fk_creditcard_customer (`id`), add constraint fk_creditcard_customer foreign key (`id`) references `customer` (`id`);
